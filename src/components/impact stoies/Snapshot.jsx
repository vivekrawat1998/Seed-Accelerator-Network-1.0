...
export default function VarietiesScalingSnapshot() {
  ...
  return (
    <div className="min-h-screen mt-20 grid grid-cols-1 md:grid-cols-2 gap-6 p-6 md:p-12">
      {/* Left Image Block */}
      <div
        className="mb-8 md:mb-0 md:mr-10 flex-shrink-0 w-full  rounded-xl overflow-hidden shadow-lg border border-green-700 bg-white flex items-center justify-center"
        data-aos="fade-right"
      >
        <img
          src={snapshotImg}
      ...
      {/* Main Card */}
      <div
        className="w-full max-w-3xl bg-white border border-green-700 rounded-xl shadow-lg px-6 md:px-12 py-8 mb-8 md:mb-0"
        data-aos="zoom-in"
      >
        <h2
