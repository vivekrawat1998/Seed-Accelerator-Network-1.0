...
const StepCard = ({ stream, index }) => {
  ...
  return (
    <div
      className={`flex flex-col md:flex-row items-center justify-between gap-8 mb-20 ${!isLeft ? 'md:flex-row-reverse' : ''
        }`}
      data-aos={isLeft ? 'fade-right' : 'fade-left'}
      data-aos-delay={150 * index}
    >
      {/* Text Section */}
      <div className="bg-white p-8 rounded-2xl md:w-1/2  transition-transform hover:scale-[1.02]">
    ...
    <div className="bg-gradient-to-b from-gray-50 to-white py-16 px-4 min-h-screen">
      ...
      <div className='grid md:grid-cols-2'>
        ...
        <div className="max-w-4xl mx-auto ">
          ...
          <p className="text-gray-700 text-lg font-Nunito mx-auto mb-4">
          ...
          <p className="text-gray-700 text-lg font-Nunito mx-auto ">
